...
export default function Home() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="sticky top-16 z-40 flex flex-col md:flex-row gap-2 md:gap-4 items-center justify-between bg-white p-3 md:p-4 rounded-xl shadow-md border transition-all duration-300">
        <div className="relative w-full md:w-96">
          <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 w-5 h-5" />
          <input 
            type="text" 
            placeholder={t('searchPlaceholder')}
            className="w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent outline-none bg-white text-gray-800"
            value={searchTerm}
